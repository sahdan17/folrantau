...
<body>
    ...
    <div class="content">
        <div class="dropdown-container">
            <label for="interval-select">Pilih  Data:</label>
    ...
    <script>
        ...
        function resetDisplay() {
            // Menghapus atau menyembunyikan elemen-elemen yang disebutkan
            if (myChart !== null) {
            myChart.destroy(); // Menghapus chart jika ada
                myChart = null;
            }
                
            $('.table1').html('');    // Menghapus konten table1
            $('.radio1').html('');    // Menghapus konten radio1
            $('.radio').html('');     // Menghapus konten radio
            $('.button1').html('');   // Menghapus konten button1
            $('.table4').html('');    // Menghapus konten table4
            $('.table3').html('');    // Menghapus konten table3
            $('.button2').html('');   // Menghapus konten button2
        ...
        function getTableData(interval, tgl) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (let interval in press) {
                        ...
                        response.spots.forEach(spot => {
                            ...
                            if (psiValues.length > 0) {
                                ...
                                table += `<th colspan="2">${average.toFixed(2)}</th>`;
                            } else {
                    ...
                    radio1 = `<label><input type="checkbox" name="predType" value="single" id="singleCheckbox" checked> Metode Regresi</label>
                    <label><input type="checkbox" name="predType" value="segmen" id="segmenCheckbox" checked> Metode Segmen</label>`;
