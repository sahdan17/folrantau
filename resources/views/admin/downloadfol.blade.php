...
<body style="background-color: white; padding-top: 130px">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                url: 'https://rtuold.findingoillosses.com/getTanggal',
                method: 'POST',
                dataType: 'json',
                headers: {
        ...
        function getDownload(tgl){
            $('.loader').show();
            $.ajax({
                url: 'https://rtuold.findingoillosses.com/getDownloadList',
                method: 'POST',
                dataType: 'json',
                data: {
                    dates: tgl
        ...
        $(document).on("click", ".download", function () {
            ...
            const form = $('<form>', {
                method: 'POST',
                action: 'https://rtuold.findingoillosses.com/downloadExcelFOL'
            });
        ...
        $(document).on("click", "#confirmDelete", function () {
            $.ajax({
                url: 'https://rtuold.findingoillosses.com/deleteDataFOL',
                method: 'POST',
                dataType: 'json',
                data: {
